...
un ambassador" basandoti sui dati 
...
{
  if(client[i].isAmbassador === true)
  console.log("nome utente: " + client[i].name + " cognome utente: " + client[i].lastName + " E' ambasciatore " + client[i].isAmbassador)
  else{
    console.log("nome utente: " + client[i].name + " cognome utente: " + client[i].lastName + " Non e' ambasciatore " + client[i].isAmbassador)
  }
}
...
if(utenteCheEffettuaLAcquisto.isAmbassador) { sommaCarrello = (sommaCarrello * 0,7)}

if(sommaCarrello <= 100) {sommaCarrello += shippingCost}
